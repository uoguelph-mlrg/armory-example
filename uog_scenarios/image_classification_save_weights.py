...
class ImageClassificationTask(Scenario):
    def _evaluate(self, config: dict) -> dict:
        ...
        if model_config["fit"]:
            ...
            ckpt_name += '_pretrained' if model_config['model_kwargs']['pretrained'] else ''
            ckpt_name += '_epochs%d.pth' % model_config['fit_kwargs']['nb_epochs']
            classifier.save(osp.join(paths.runtime_paths().saved_model_dir, ckpt_name))
