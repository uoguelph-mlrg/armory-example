"""
VGG-16 CNN model for 244x244x3 image classification
...
def resisc_vgg16(model_kwargs):

    model = models.vgg16(**model_kwargs)
...
def get_art_model(model_kwargs, wrapper_kwargs, weights_file=None):
    ...
    model_pre_softmax = resisc_vgg16(model_kwargs)
